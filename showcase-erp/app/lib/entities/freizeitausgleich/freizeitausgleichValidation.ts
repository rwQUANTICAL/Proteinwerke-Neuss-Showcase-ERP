...
export const freizeitausgleichSchema = z
  .object({
...
export type FreizeitausgleichFormData = z.infer<typeof freizeitausgleichSchema>;

/** Checks whether a new date range overlaps with any existing Antrag (BEANTRAGT or GENEHMIGT). */
