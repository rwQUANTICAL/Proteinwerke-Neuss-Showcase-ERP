...
export async function sendCompTimeRequestEmail({
  employeeName,
  von,
  bis,
  days,
  ...
  const html = buildCompTimeRequestHtml({
    employeeName,
    von,
    bis,
    days,
...
function buildCompTimeRequestHtml({
  employeeName,
  von,
  bis,
  days,
  ...
  const hasShifts = affectedShifts.some((s) => s.originalSchicht !== null);
          ...
          <tr>
            <td style="padding:44px 40px 48px;">
              <h1 style="margin:0 0 12px;font-size:22px;font-weight:700;color:${infoColor};letter-spacing:-0.01em;">
                Freizeitausgleich beantragt
              </h1>
              <p style="margin:0 0 32px;font-size:15px;line-height:1.7;color:${textMuted};">
                Ein Mitarbeiter hat einen Antrag auf Freizeitausgleich (Überstundenabbau) eingereicht. Bitte prüfen und genehmigen oder ablehnen.
              </p>
                ...
                <tr>
                  <td style="padding:24px 28px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding:8px 0;font-size:14px;color:${textMuted};">Stundensaldo</td>
                        <td style="padding:8px 0;font-size:14px;color:${saldo >= 0 ? primary : "#dc2626"};text-align:right;font-weight:600;">
                          ${fmtHM(saldo)} Std.
                        </td>
                      </tr>
                      <tr>
