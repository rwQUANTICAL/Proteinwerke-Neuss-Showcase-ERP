...
export default function AdminUrlaubsantragList() {
  const { data: antraege, isLoading } = useAllUrlaubsantraegeQuery();
  const patchMutation = usePatchUrlaubsantragMutation();
